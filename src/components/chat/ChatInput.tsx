...
export function ChatInput({
  ...
  if (theme === 'kakao') {
    return (
      <div className="h-[44px] bg-white flex items-center px-2 z-10">
        <div className="w-7 h-7 border border-gray-300 rounded-[7px] flex justify-center items-center text-gray-500 mr-2 flex-shrink-0 cursor-pointer hover:bg-gray-50">
  ...
  if (theme === 'line') {
    return (
      <div className="h-[50px] bg-white flex items-center px-[10px] border-t border-[#dcdcdc] z-10">
        {/* 좌측 아이콘들 */}
  ...
  if (theme === 'imessage') {
    return (
      <div className="min-h-[48px] bg-white flex items-end py-2 px-3 gap-[10px] border-t border-[#E5E5E5]">
        {/* + 버튼 */}
        <div className="w-7 h-7 bg-[#D1D1D6] rounded-full flex justify-center items-center flex-shrink-0 cursor-pointer mb-1">
